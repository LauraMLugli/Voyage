          ...
          {tabs.map((tab) => (
            ...
            >
              <MaterialCommunityIcons
                name={tab.icon}
                size={18}
                color={activeTab === tab.key ? palette.secondary : palette.muted}
              />
              ...
              {[
                ...
                <View key={item.line} style={styles.busItem}>
                  <View style={styles.busIconContainer}>
                    <MaterialCommunityIcons name="bus" size={18} color={palette.secondary} />
                  </View>
                ...
                <View key={item.id} style={styles.transactionItem}>
                  <View style={[styles.transactionIcon, item.ride && styles.transactionRideIcon]}>
                    <MaterialCommunityIcons
                      ...
                      size={18}
                      color={item.ride ? palette.primary : palette.secondary}
                    />
                  </View>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalCard}>
            ...
            <View style={styles.modalIcon}>
              <MaterialCommunityIcons name="wallet" size={24} color={palette.secondary} />
            </View>
